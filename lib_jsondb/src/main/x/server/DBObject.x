/**
 * A mixin that implements the `DBObject` interface, and identifies each using a small numeric
 * value.
 */
@Abstract mixin DBObject
        implements oodb.DBObject
    {
//    protected DBObjectInfo
//    protected/private UInt32 id;
//
//    @Override
//    DBObject!? dbParent.get()
//        {
//        TODO
//        }
//
...
//     */
//    @Override
//    public/private String dbPath.get()
//        {
...
//     */
//    @Override
//Map<String, DBObject!> dbChildren;
//
//    /**
