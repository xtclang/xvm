...
// TODO path literals issue
    static DBObjectInfo[] SystemInfos =
        ...
        new DBObjectInfo("info",         Path:/sys/info,         DBValue,   BuiltIn.Info.id,         BuiltIn.Sys.id, typeParams=["Value"=DBInfo]),
        new DBObjectInfo("users",        Path:/sys/users,        DBMap,     BuiltIn.Users.id,        BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBUser]),
        new DBObjectInfo("types",        Path:/sys/types,        DBMap,     BuiltIn.Types.id,        BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=Type]),
        new DBObjectInfo("objects",      Path:/sys/objects,      DBMap,     BuiltIn.Objects.id,      BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBObject]),
        new DBObjectInfo("schemas",      Path:/sys/schemas,      DBMap,     BuiltIn.Schemas.id,      BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBSchema]),
        new DBObjectInfo("counters",     Path:/sys/counters,     DBMap,     BuiltIn.Counters.id,     BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBCounter]),
        new DBObjectInfo("values",       Path:/sys/values,       DBMap,     BuiltIn.Values.id,       BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBValue]),
        new DBObjectInfo("maps",         Path:/sys/maps,         DBMap,     BuiltIn.Maps.id,         BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBMap]),
        new DBObjectInfo("lists",        Path:/sys/lists,        DBMap,     BuiltIn.Lists.id,        BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBList]),
        new DBObjectInfo("queues",       Path:/sys/queues,       DBMap,     BuiltIn.Queues.id,       BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBQueue]),
        new DBObjectInfo("processors",   Path:/sys/processors,   DBMap,     BuiltIn.Processors.id,   BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBProcessor]),
        new DBObjectInfo("logs",         Path:/sys/logs,         DBMap,     BuiltIn.Logs.id,         BuiltIn.Sys.id, typeParams=["Key"=String, "Value"=DBLog]),
        new DBObjectInfo("pending",      Path:/sys/pending,      DBList,    BuiltIn.Pending.id,      BuiltIn.Sys.id, typeParams=["Element"=Pending]),
        new DBObjectInfo("transactions", Path:/sys/transactions, DBLog,     BuiltIn.Transactions.id, BuiltIn.Sys.id, typeParams=["Element"=DBTransaction]),
        new DBObjectInfo("errors",       Path:/sys/errors,       DBLog,     BuiltIn.Errors.id,       BuiltIn.Sys.id, typeParams=["Element"=String]),
