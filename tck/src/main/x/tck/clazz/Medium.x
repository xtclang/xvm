...
class Medium {
    ...
    void incorpConditional() {
        ...
        class Base1<Element extends Const/*GG bug*/> extends Super1<Element> incorporates conditional MixIn<Element extends String> {
            @Override String add(Element e) = $"B[{e=} " + super(e) + " ]B";
        }
        class Derived1<Element> extends Base1<Element> {
            @Override String add(Element e) = $"D[{e=} " + super(e) + " ]D";
        ...
        class Base2<Element extends Const/*GG bug*/> extends Super2<Element> incorporates conditional MixIn<Element> {
            @Override String add(Element e) = $"b[{e=} " + super(e) + " ]b";
        }
        class Derived2<Element> extends Base2<Element> {
            @Override String add(Element e) = $"d[{e=} " + super(e) + " ]d";
