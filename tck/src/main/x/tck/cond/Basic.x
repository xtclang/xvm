...
class Basic {
    ...
    void test1() {
        assert !test();
        conditional String test() { return False; }
    }

    @Test
    void test2() {
        assert String s := test(), s=="abc";
        conditional String test() { return (True,"abc"); }
    }
    ...
    void test4() {
        ...
        conditional String test(Boolean b0) { return b0 ? False : (True,"abc"); }
    }
    ...
    void test5() {
        ...
        conditional String test(Boolean b0, Boolean b1) { return b0 ? (b1 ? False : (True,"def")) : (b1 ? (True,"abc") : (True, "xyz")); }
    }
    ...
    void test6() {
        ...
        conditional String test0(Boolean b0, Boolean b1) { return b0 ? test1(b1) : (True,"abc"); }
        conditional String test1(Boolean b1) { return b1 ? False : (True,"def"); }
    }
