...
public class Char extends nConst {
    ...
    /**
     * Add an Int64 value to a Char codepoint. Call to this method are generated by the JIT's
     * "TextSupport.buildAddIntToChar" method.
     *
     ...
     * JIT's "TextSupport.buildSubIntFromChar" method.
     *
     * @param ctx        the runtime context
     * @param codepoint  the codepoint to add to
     * @param n          the value to add to the codepoint
