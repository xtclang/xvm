...
public class ArrayᐸUInt8ᐳ
    ...
    public String toString(Ctx ctx) {
        ...
        sb.append("0x");
        for (int i = 0; i < cb; i++) {
            long value = ($storage[i >>> 3] >>> ((7 - (i & 0x7)) << 3) & 0xFFL);
            int  n1    = (int) (value & 0x0F);
            int  n2    = (int) (value >>> 4);
            char c1    = (char) (n1 <= 9 ? '0' + n1 : 'A' + n1 - 0xA);
            char c2    = (char) (n2 <= 9 ? '0' + n2 : 'A' + n2 - 0xA);
            sb.append(Character.valueOf(c2));
            sb.append(Character.valueOf(c1));
        }
