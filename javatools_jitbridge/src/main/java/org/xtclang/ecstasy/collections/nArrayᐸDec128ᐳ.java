 ...
 * Storage - ref
 */
public class nArrayᐸDec128ᐳ
        extends nLongBasedArray<nArrayᐸDec128ᐳ> {

    public nArrayᐸDec128ᐳ(Ctx ctx, TypeConstant type) {
        super(ctx, type);
    }
     ...
     */
    public static nArrayᐸDec128ᐳ $new$p(Ctx ctx, TypeConstant type, long capacity, boolean _capacity) {
        assert !type.isImmutable();

        ctx.alloc(64); // REVIEW how big?
        nArrayᐸDec128ᐳ array = new nArrayᐸDec128ᐳ(ctx, type);
        array.$mut($MUTABLE);
        array.$capCfg(ctx, capacity);
        return array;
    }

    public static nArrayᐸDec128ᐳ $new$1$p(Ctx ctx, TypeConstant type, long size, nObj supply) {
        // TODO
        throw new UnsupportedOperationException();
    }

    public static nArrayᐸDec128ᐳ $new$2$p(Ctx ctx, TypeConstant type, Mutability mutability, Iterable elements) {
        // TODO
        throw new UnsupportedOperationException();
    }

    public static nArrayᐸDec128ᐳ $new$3$p(Ctx ctx, TypeConstant type, nArrayᐸDec128ᐳ that) {
        // TODO
        throw new UnsupportedOperationException();
    }

    @Override public Dec128 getElement$p(Ctx ctx, long index) {
    ...
    @Override
    public nArrayᐸDec128ᐳ add(Ctx ctx, nObj element) {
        return add$p(ctx, ((Dec128) element).$lowBits, ((Dec128) element).$highBits);
    }

    public nArrayᐸDec128ᐳ add$p(Ctx ctx, long lowValue, long highValue) {
        ctx.i0 = highValue;
        return super.add$p(ctx, lowValue);
    }

    @Override
    public nArrayᐸDec128ᐳ slice(Ctx ctx, nRangeᐸInt64ᐳ range) {
        return (nArrayᐸDec128ᐳ) super.slice(ctx, range);
    }
