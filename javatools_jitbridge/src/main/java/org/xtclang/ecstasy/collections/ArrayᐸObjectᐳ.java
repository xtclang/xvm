...
public class ArrayᐸObjectᐳ
    ...
    // ToDo GG/JK remove this when it can be generated by the JIT; this would work *only* if the
    // array is cast to an Object anyway
    @Override
...
//        }
    ...
    @Override protected void $shrinkToSize(Ctx ctx) {
        ...
        if ($storage != null && $storage.length > size) {
            nObject[] newArray = new nObject[size];
    ...
    @Override protected void $delete(Ctx ctx, long index, long count) {
        ...
        if (newSize == 0) {
            ...
            nObject[] newArray = new nObject[newCap];
            if (moveTo > 0) {
