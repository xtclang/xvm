...
public class Float8e5 extends BinaryFPNumber {
    /**
     * Construct an Ecstasy Float8e5 object.
     *
     ...
     *
     * @param value  an 8-bit E5M2 encoding
     *
    ...
    /**
     * @param bits  an 8-bit E5M2 encoding
     *
     * @return the value it encodes, as a Java float
     */
    public static float $toFloat(int bits) {
        return Float8e5Constant.toFloat(bits & 0xFF);
    }

    /**
     * E5M2 follows IEEE-754: the all-1s exponent encodes infinity and NaN.
     *
     * @return true iff the encoded value is finite
     */
    public static boolean $finite(int bits) {
        return (bits & 0x7C) != 0x7C;
    }

    /**
     * @return true iff the encoded value is an infinity, i.e. #7C or #FC
     */
    ...
    /**
     * @return true iff the encoded value is a NaN, i.e. #7D through #7F, or #FD through #FF
     */
    ...
    public static int $toBits(float value) {
        return Float8e5Constant.toBits(value);
    }
    ...
    public static Ordered compare(Ctx ctx, nType type, Orderable value1, Orderable value2) {
        ...
        float l2 = $toFloat(((Float8e5) value2).$value);
