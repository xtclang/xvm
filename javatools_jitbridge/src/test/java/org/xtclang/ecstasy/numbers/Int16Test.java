...
public class Int16Test {
    ...
    public void shouldConvertToInt8() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n       = Int16.$box(i);
            int   n2      = Int16.toInt8$p(n.$value, null, false, true);
            int  expected = (byte) i;
    ...
    public void shouldConvertToInt8WithBoundsCheck() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            ...
            if (i < Byte.MIN_VALUE || i > Byte.MAX_VALUE) {
                try {
                    Int16.toInt8$p(n.$value, null, true, false);
                } catch (nException e) {
                    assertInstanceOf(OutOfBounds.class, e.exception);
                }
            } else {
                int n2 = Int16.toInt8$p(n.$value, null, true, false);
                assertEquals(i, n2);
            }
        }
    }
    ...
    public void shouldConvertToUInt8() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n        = Int16.$box(i);
            int   n2       = Int16.toUInt8$p(n.$value, null, false, true);
            int   expected = i & 0xFF;
            assertEquals(expected, n2);
        }
    }
    ...
    public void shouldConvertToUInt8WithBoundsCheck() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            ...
            if (i < 0 || i > Byte.MAX_VALUE) {
                try {
                    Int16.toUInt8$p(n.$value, null, true, false);
                } catch (nException e) {
                    assertInstanceOf(OutOfBounds.class, e.exception);
                }
            } else {
                int n2 = Int16.toUInt8$p(n.$value, null, true, false);
                assertEquals(i, n2);
            }
        }
    }
    ...
    public void shouldConvertToInt16() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n = Int16.$box(i);
            int   n2 = Int16.toInt16$p(n.$value, null, false, true);
            assertEquals(i, n2);
        }
    }
    ...
    public void shouldConvertToUInt16() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n        = Int16.$box(i);
            int   n2       = Int16.toUInt16$p(n.$value, null, false, true);
    ...
    public void shouldConvertToUInt16WithBoundsCheck() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            ...
            if (i < 0) {
                try {
                    Int16.toUInt16$p(n.$value, null, true, false);
                } catch (nException e) {
                    assertInstanceOf(OutOfBounds.class, e.exception);
                }
            } else {
                int n2 = Int16.toUInt16$p(n.$value, null, true, false);
                assertEquals(i, n2);
            }
        }
    }
    ...
    public void shouldConvertToInt32() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n  = Int16.$box(i);
            int   n2 = Int16.toInt32$p(n.$value, null, false, true);
            assertEquals(i, n2);
        }
    }
    ...
    public void shouldConvertToUInt32() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n  = Int16.$box(i);
            int   n2 = Int16.toUInt32$p(n.$value, null, false, true);
            assertEquals(i, n2);
        }
    }
    ...
    public void shouldConvertToUInt32WithBoundsCheck() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            ...
            if (i < 0) {
                try {
                    Int16.toUInt32$p(n.$value, null, true, false);
                } catch (nException e) {
                    assertInstanceOf(OutOfBounds.class, e.exception);
                }
            } else {
                int n2 = Int16.toUInt32$p(n.$value, null, true, false);
                assertEquals(i, n2);
            }
        }
    }
    ...
    public void shouldConvertToInt64() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n  = Int16.$box(i);
            long  n2 = Int16.toInt64$p(n.$value, null, false, true);
            assertEquals(i, n2);
        }
    }
    ...
    public void shouldConvertToUInt64() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n  = Int16.$box(i);
            long  n2 = Int16.toUInt64$p(n.$value, null, false, true);
            assertEquals(i, n2);
        }
    }
    ...
    public void shouldConvertToUInt64WithBoundsCheck() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            ...
            if (i < 0) {
                try {
                    Int16.toUInt64$p(n.$value, null, true, false);
                } catch (nException e) {
                    assertInstanceOf(OutOfBounds.class, e.exception);
                }
            } else {
                long n2 = Int16.toUInt64$p(n.$value, null, true, false);
                assertEquals(i, n2);
            }
        }
    }
    ...
    public void shouldConvertToInt128() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            ...
            long  n2  = Int16.toInt128$p(n.$value, ctx, false, true);
            assertEquals(i, n2);
            if (i < 0) {
    ...
    public void shouldConvertToUInt128() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            Int16 n   = Int16.$box(i);
            Ctx   ctx = new Ctx(null, null);
            long  n2  = Int16.toUInt128$p(n.$value, ctx, false, true);
            assertEquals(i, n2);
            if (i < 0) {
                assertEquals(-1L, ctx.i0);
            } else {
    ...
    public void shouldConvertToUInt128WithBoundsCheck() {
        for (int i = Short.MIN_VALUE; i <= Short.MAX_VALUE; i++) {
            ...
            if (i < 0) {
                try {
                    Int16.toUInt128$p(n.$value, null, true, false);
                } catch (nException e) {
                    assertInstanceOf(OutOfBounds.class, e.exception);
                }
            } else {
                long n2 = Int16.toUInt128$p(n.$value, ctx, true, false);
                assertEquals(i, n2);
                assertEquals(0L, ctx.i0);
            }
        }
