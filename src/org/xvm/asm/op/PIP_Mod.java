...
public class PIP_Mod
     ...
     */
    public PIP_Mod(PropertyConstant constProperty, Argument argTarget, Argument argValue)
        {
    ...
    protected int complete(Frame frame, ObjectHandle hTarget, String sPropName, ObjectHandle hValue)
        {
        return hTarget.getTemplate().invokePropertyMod(frame, hTarget, sPropName, hValue);
        }
    }