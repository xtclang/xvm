...
public class PIP_ShrAll
     ...
     */
    public PIP_ShrAll(PropertyConstant constProperty, Argument argTarget, Argument argValue)
        {
    ...
    protected int complete(Frame frame, ObjectHandle hTarget, String sPropName, ObjectHandle hValue)
        {
        return hTarget.getTemplate().invokePropertyShrAll(frame, hTarget, sPropName, hValue);
        }
    }