...
public class PIP_Shl
     ...
     */
    public PIP_Shl(PropertyConstant constProperty, Argument argTarget, Argument argValue)
        {
    ...
    protected int complete(Frame frame, ObjectHandle hTarget, String sPropName, ObjectHandle hValue)
        {
        return hTarget.getTemplate().invokePropertyShl(frame, hTarget, sPropName, hValue);
        }
    }