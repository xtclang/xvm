...
public abstract class Op
    ...
    public static final int OP_CAST         = 0x4B;

    public static final int OP_GP_ADD       = 0x4C;
    public static final int OP_GP_SUB       = 0x4D;
    public static final int OP_GP_MUL       = 0x4E;
    public static final int OP_GP_DIV       = 0x4F;
    public static final int OP_GP_MOD       = 0x50;
    public static final int OP_GP_SHL       = 0x51;
    public static final int OP_GP_SHR       = 0x52;
    public static final int OP_GP_USHR      = 0x53;
    public static final int OP_GP_AND       = 0x54;
    public static final int OP_GP_OR        = 0x55;
    public static final int OP_GP_XOR       = 0x56;
    public static final int OP_GP_DIVMOD    = 0x57;
    public static final int OP_GP_NEG       = 0x58;
    public static final int OP_GP_COMPL     = 0x59;

    public static final int OP_L_GET        = 0x5A;
    public static final int OP_L_SET        = 0x5B;
    public static final int OP_P_GET        = 0x5C;
    public static final int OP_P_SET        = 0x5E;
    public static final int OP_P_VAR        = 0x60;
    public static final int OP_P_REF        = 0x61;

    public static final int OP_IP_INC       = 0x62;
    public static final int OP_IP_DEC       = 0x63;
    public static final int OP_IP_INCA      = 0x64;
    public static final int OP_IP_DECA      = 0x67;
    public static final int OP_IP_INCB      = 0x68;
    public static final int OP_IP_DECB      = 0x69;
    public static final int OP_IP_ADD       = 0x6A;
    public static final int OP_IP_SUB       = 0x6B;
    public static final int OP_IP_MUL       = 0x6C;
    public static final int OP_IP_DIV       = 0x6D;
    public static final int OP_IP_MOD       = 0x6E;
    public static final int OP_IP_SHL       = 0x6F;
    public static final int OP_IP_SHR       = 0x70;
    public static final int OP_IP_USHR      = 0x71;
    public static final int OP_IP_AND       = 0x72;
    public static final int OP_IP_OR        = 0x73;
    public static final int OP_IP_XOR       = 0x74;

    public static final int OP_PIP_INC      = 0x75;
    public static final int OP_PIP_DEC      = 0x76;
    public static final int OP_PIP_INCA     = 0x77;
    public static final int OP_PIP_DECA     = 0x78;
    public static final int OP_PIP_INCB     = 0x79;
    public static final int OP_PIP_DECB     = 0x7A;
    public static final int OP_PIP_ADD      = 0x7B;
    public static final int OP_PIP_SUB      = 0x7C;
    public static final int OP_PIP_MUL      = 0x7D;
    public static final int OP_PIP_DIV      = 0x7E;
    public static final int OP_PIP_MOD      = 0x7F;
    public static final int OP_PIP_SHL      = 0x80;
    public static final int OP_PIP_SHR      = 0x81;
    public static final int OP_PIP_USHR     = 0x82;
    public static final int OP_PIP_AND      = 0x83;
    public static final int OP_PIP_OR       = 0x84;
    public static final int OP_PIP_XOR      = 0x85;

    public static final int OP_I_GET        = 0x86;
    public static final int OP_I_SET        = 0x87;
    public static final int OP_I_VAR        = 0x88;
    ...
    public static final int OP_M_VAR        = 0x9D;
    public static final int OP_M_REF        = 0x9E;
    public static final int OP_MIP_INC      = 0x9F;
    public static final int OP_MIP_DEC      = 0xA0;
    public static final int OP_MIP_INCA     = 0xA1;
    public static final int OP_MIP_DECA     = 0xA2;
    public static final int OP_MIP_INCB     = 0xA3;
    public static final int OP_MIP_DECB     = 0xA4;
    public static final int OP_MIP_ADD      = 0xA5;
    public static final int OP_MIP_SUB      = 0xA6;
    public static final int OP_MIP_MUL      = 0xA7;
    public static final int OP_MIP_DIV      = 0xA8;
    public static final int OP_MIP_MOD      = 0xA9;
    public static final int OP_MIP_SHL      = 0xAA;
    public static final int OP_MIP_SHR      = 0xAB;
    public static final int OP_MIP_USHR     = 0xAC;
    public static final int OP_MIP_AND      = 0xAD;
    public static final int OP_MIP_OR       = 0xAE;
    public static final int OP_MIP_XOR      = 0xAF;
