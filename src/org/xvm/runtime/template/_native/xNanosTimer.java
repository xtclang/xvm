...
public class xNanosTimer
    ...
    /**
     * @return true if the timer is running (the last call to "start" has not been follwed by a call
     *         to "stop")
     */
     ...
     */
    public TypeComposition ensureDurationClass()
        {
