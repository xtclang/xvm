...
/**
 * A `ParameterResolver` is able to resolve values for parameters to be used to call methods and
 * functions.
 */
interface ParameterResolver
     ...
     *
     * @return a `Map` of resolved parameters keyed by `Parameter` mapped to the resolved value for
     *         that `Parameter`
     *
