...
Typed prefixes are implemented in the follow-up below. Additional value sources, specialized
construction and declaration/tuple/literal recovery remain subsequent investigations. Automatic
