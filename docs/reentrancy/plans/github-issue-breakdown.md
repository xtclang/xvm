...
| Runtime failure propagation | MainContainer cause-preservation wave and worker terminal-failure channel | JIT exception propagation and broad exception hygiene |
