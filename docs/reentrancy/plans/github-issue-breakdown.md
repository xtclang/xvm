...
| 8b | Preserve runtime failure causes and worker failures | Keeps owner, pool, module, stack, and worker-defect evidence when startup/runtime setup fails. | Independent; stronger after PR 8 diagnostics |
...
| Runtime failure propagation | MainContainer cause-preservation wave and worker terminal-failure channel | JIT bridge reflective exception propagation and broad exception hygiene |
