...
| Runtime failure propagation | MainContainer cause-preservation wave, worker terminal-failure channel, and op-loop VM-defect propagation | Broad exception hygiene |
