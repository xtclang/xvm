...
| `org.xvm.asm.OpRuntimeCacheTest` | Runtime `Op` condition/common-type cache fields still exist. | Shared decoded op graphs could retain frame-owned constants from one execution. |
