...
| `javatools/src/main/java/org/xvm/asm/constants/MethodInfo.java:1484` | Same hidden-pool helper for method metadata. JIT and runtime metadata can reach `MethodInfo`. | Store/pass the TypeInfo/method owner pool. |
