...
| `javatools/src/main/java/org/xvm/asm/constants/FSNodeConstant.java:238` | Branch override that clears cloned runtime file-system handle state. | Fixed must-fix site. Prevents copied runtime handles from crossing pools. |
