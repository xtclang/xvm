...
class Lexer
    ...
    enum Id(String? text, Category category=Normal)
        ...
        Continue     ("continue"       ),
        Default      ("default"        ),
        Delegates    ("delegates"      , ContextSensitive),
        Do           ("do"             ),
        Else         ("else"           ),
        Enum         ("enum"           ),
        Extends      ("extends"        , ContextSensitive),
        Finally      ("finally"        ),
        For          ("for"            ),
        Function     ("function"       ),
        If           ("if"             ),
        Immutable    ("immutable"      ),
        Implements   ("implements"     , ContextSensitive),
        Import       ("import"         ),
        ImportEmbed  ("import:embedded"),
        ImportRequire("import:required"),
        ImportDesire ("import:desired" ),
        ImportOption ("import:optional"),
        Incorporates ("incorporates"   , ContextSensitive),
        Interface    ("interface"      ),
        Into         ("into"           , ContextSensitive),
        Is           ("is"             ),
        Mixin        ("mixin"          ),
        Module       ("module"         ),
        New          ("new"            ),
        Outer        ("outer"          , Special),
        Package      ("package"        ),
        Prefer       ("prefer"         , ContextSensitive),
        Private      ("private"        ),
        Protected    ("protected"      ),
        Public       ("public"         ),
        Return       ("return"         ),
        ...
        Switch       ("switch"         ),
        This         ("this"           , Special),
        ThisClass    ("this:class"     , Special),
        ThisModule   ("this:module"    , Special),
        ThisPri      ("this:private"   , Special),
        ThisPro      ("this:protected" , Special),
        ThisPub      ("this:public"    , Special),
        ThisServ     ("this:service"   , Special),
        ThisStruct   ("this:struct"    , Special),
        ThisTarget   ("this:target"    , Special),
        Throw        ("throw"          ),
        Todo         ("TODO"           ),
        Try          ("try"            ),
        Typedef      ("typedef"        ),
        Using        ("using"          ),
        Val          ("val"            , ContextSensitive),
        Var          ("var"            , ContextSensitive),
        Void         ("void"           ),
        While        ("while"          ),
        Identifier   (Null             ),
        LitChar      (Null             ),
