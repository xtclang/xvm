const Int32
    ...
    Int32 retainLSBits(Int count)
        ...
        return new Int32(bits.fill(0, 0..bitLength-count-1));
        }
    ...
    Int32 retainMSBits(Int count)
        ...
        return new Int32(bits.fill(0, count..bitLength-1));
        }

    @Override
    Int32 reverseBits()
        {
        return new Int32(bits.reverse());
        }

    @Override
    Int32 reverseBytes()
        {
        return new Int32(toByteArray().reverse());
        }
