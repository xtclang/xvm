...
//
//    @Override
//    DirectPrinter addArray(String name, Iterable<Doc> values)
//        {
//        printName(name);
//        out.add('[');
...
//
//    @Override
//    DirectPrinter addArray(String name, Iterable<IntNumber> values)
//        {
//        printName(name);
//        out.add('[');
...
//
//    @Override
//    DirectPrinter addArray(String name, Iterable<FPNumber> values)
//        {
//        printName(name);
//        out.add('[');
