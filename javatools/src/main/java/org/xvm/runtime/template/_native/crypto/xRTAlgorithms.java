...
public class xRTAlgorithms
        extends xService {
    public xRTAlgorithms(Container container, ClassStructure structure) {
    ...
    private int invokeGetAlgorithmInfo(Frame frame, StringHandle hName, EnumHandle hMethod,
        ...
        try {
            ...
            case 0: { // Hasher
                ...
                nBlockSize = 0;
                hImpl      = new DigestHandle(container, digest);
                break;
            }
            ...
            case 2: { // AsymmetricalCipher
                ...
                hImpl      = new CipherHandle(container, cipher);
                break;
            }
            ...
            case 3: { // MAC (Symmetric Cryptography)
                ...
                nBlockSize = 0;
                hImpl      = new MacHandle(container, mac);
                break;
            }
            ...
            case 4: { // Signature (Asymmetric Cryptography)
                ...
                nBlockSize = 0;
                hImpl      = new SignatureHandle(container, sig);
                break;
            }
            ...
            case 5: { // KeyGenerator
                ...
                nBlockSize = 0;
                hImpl      = new KeyGenHandle(container, generator);
                break;
            }
