...
public enum JitFlavor {
     ...
     *
     * <p>Implication is that it uses a single slot and no casts or transformations are required.
     */
    Specific(false, null),
     ...
     *
     * <p>Implication is that a Java `null` value is allowed to passed in, indicating that the default
     ...
     *
     * <p>Implication is that it uses a single slot and casts are required.
     */
    Widened(false, null),
     ...
     *
     * <p>Implication is that a `null` value is allowed to passed in, indicating that the default
     * value should be used.
     *
     * <p>Note: this flavor can only be used by the {@link JitMethodDesc}
     */
     ...
     * Boolean, Char, Int)
     *
     * <p>Implication is that it uses a single slot and transformations (boxing/unboxing) may be
     * required.
     */
    Primitive(true, null),
     ...
     *
     * <p>Implication is that an additional `boolean` value is used, with `true` indicating that the
     ...
     *
     * <p>The implication is that it uses multiple slots and transformations (boxing/unboxing) may be
     * required.
     */
     ...
     * primitives.
     *
     * <p>Implication is that an additional `boolean` value is used, indicating that the default
     * value should be used.
     *
     * <p>Note: this flavor can only be used by the {@link JitMethodDesc}
     */
     ...
     *
     * <p>Implication is that an additional `boolean` value is used, indicating that the value is Null.
     */
