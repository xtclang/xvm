...
public class ExceptionBuilder extends CommonBuilder {
    ...
    /**
     * Compute the Java superclass of the exception-shaped class generated by this builder.
     */
    public ClassDesc getJavaExceptionSuperCD() {
        TypeConstant superType = typeInfo.getExtends();
        return superType.equals(typeSystem.pool().typeException())
                ? CD_nException
                : getShapeDesc(ensureJitClassName(superType), ClassfileShape.Exception);
    }
}
