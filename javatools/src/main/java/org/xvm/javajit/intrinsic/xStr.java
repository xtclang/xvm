...
public class xStr
     ...
     */
    public xStr(long containerId, String s) {
        super(containerId);
     ...
     */
    public xStr(long containerId, byte[] utf8) {
        // TODO
     ...
     * @param next
     */
    xStr(long containerId, long[] data, boolean unicode, long hash, int start, int end, xStr next) {
        super(containerId);
        this.data       = data;
     ...
     */
    public static final xStr EmptyString = new xStr(0, new long[0], true, 0, 0, 0, null);
