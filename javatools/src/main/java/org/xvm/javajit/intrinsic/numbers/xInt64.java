...
public class xInt64 extends xConst {
    ...
    private static final xInt64[] SMALL_CACHE        = new xInt64[SMALL_CACHE_SIZE];

    public static final xInt64 ZERO    = $box(0);
    public static final xInt64 ONE     = $box(1);
    public static final xInt64 NEG_ONE = $box(-1);
    public static final xInt64 MIN     = $box(Long.MIN_VALUE);
    public static final xInt64 MAX     = $box(Long.MAX_VALUE);
     ...
     */
    public static xInt64 $box(long value) {
        long key = value + SMALL_CACHE_OFFSET;
        if ((key & -SMALL_CACHE_SIZE) == 0) {
            xInt64 ref = SMALL_CACHE[(int) key];
            if (ref == null) {
                SMALL_CACHE[(int) key] = ref = new xInt64(value);
            }
            return ref;
        }
