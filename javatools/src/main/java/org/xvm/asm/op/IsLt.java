...
public class IsLt
        extends OpTest {
    /**
     * Construct an IS_LT op based on the specified arguments.
     *
     ...
     */
    public IsLt(TypeConstant type, Argument arg1, Argument arg2, Argument argReturn) {
    ...
    public IsLt(DataInput in, Constant[] aconst)
            throws IOException {
        super(in, aconst, TestShape.BINARY);
    }
