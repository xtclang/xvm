 ...
 * <p>Each CATCH_END op must match up with a previous CATCH op.
 * <p>The CATCH_END op exits the scope and proceeds to the instruction at the location specified by
 * "rel_addr".
 */
