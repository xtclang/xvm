...
public abstract class Op
    ...
    public static final int OP_JMP_NFIRST   = 0x2C;
    public static final int OP_JMP_NSAMPLE  = 0x2D;
    public static final int OP_JMP_INT      = 0x2E;
    public static final int OP_JMP_VAL      = 0x2F;
    public static final int OP_JMP_VAL_N    = 0x30;

    public static final int OP_IS_ZERO      = 0x31;
    public static final int OP_IS_NZERO     = 0x32;
    public static final int OP_IS_NULL      = 0x33;
    public static final int OP_IS_NNULL     = 0x34;
    public static final int OP_IS_EQ        = 0x35;
    public static final int OP_IS_NEQ       = 0x36;
    public static final int OP_IS_LT        = 0x37;
    public static final int OP_IS_LTE       = 0x38;
    public static final int OP_IS_GT        = 0x39;
    public static final int OP_IS_GTE       = 0x3A;
    public static final int OP_IS_NOT       = 0x3B;
    public static final int OP_IS_TYPE      = 0x3C;
    public static final int OP_IS_NTYPE     = 0x3D;
    public static final int OP_IS_SVC       = 0x3E;
    public static final int OP_IS_CONST     = 0x3F;
    public static final int OP_IS_IMMT      = 0x40;
    public static final int OP_CMP          = 0x41;

    public static final int OP_VAR          = 0x42;
    public static final int OP_VAR_I        = 0x43;
    public static final int OP_VAR_N        = 0x44;
    public static final int OP_VAR_IN       = 0x45;
    public static final int OP_VAR_D        = 0x46;
    public static final int OP_VAR_DN       = 0x47;
    public static final int OP_VAR_C        = 0x48;
    public static final int OP_VAR_CN       = 0x49;
    public static final int OP_VAR_S        = 0x4A;
    public static final int OP_VAR_SN       = 0x4B;
    public static final int OP_VAR_T        = 0x4C;
    public static final int OP_VAR_TN       = 0x4D;
    public static final int OP_VAR_M        = 0x4E;
    public static final int OP_VAR_MN       = 0x4F;

    public static final int OP_MOV          = 0x50;
    public static final int OP_MOV_VAR      = 0x51;
    public static final int OP_MOV_REF      = 0x52;
    public static final int OP_MOV_THIS     = 0x53;
    public static final int OP_MOV_THIS_A   = 0x54;
    public static final int OP_CAST         = 0x55;

    public static final int OP_GP_ADD       = 0x56;
    public static final int OP_GP_SUB       = 0x57;
    public static final int OP_GP_MUL       = 0x58;
    public static final int OP_GP_DIV       = 0x59;
    public static final int OP_GP_MOD       = 0x5A;
    public static final int OP_GP_SHL       = 0x5B;
    public static final int OP_GP_SHR       = 0x5C;
    public static final int OP_GP_USHR      = 0x5E;
    public static final int OP_GP_AND       = 0x60;
    public static final int OP_GP_OR        = 0x61;
    public static final int OP_GP_XOR       = 0x62;
    public static final int OP_GP_DIVREM    = 0x63;
    public static final int OP_GP_DOTDOT    = 0x64;
    public static final int OP_GP_DOTDOTEX  = 0x65;
    public static final int OP_GP_NEG       = 0x67;
    public static final int OP_GP_COMPL     = 0x68;

    public static final int OP_L_GET        = 0x69;
    public static final int OP_L_SET        = 0x6A;
    public static final int OP_P_GET        = 0x6B;
    public static final int OP_P_SET        = 0x6C;
    public static final int OP_P_VAR        = 0x6D;
    public static final int OP_P_REF        = 0x6E;

    public static final int OP_IP_INC       = 0x6F;
    public static final int OP_IP_DEC       = 0x70;
    public static final int OP_IP_INCA      = 0x71;
    public static final int OP_IP_DECA      = 0x72;
    public static final int OP_IP_INCB      = 0x73;
    public static final int OP_IP_DECB      = 0x74;
    public static final int OP_IP_ADD       = 0x75;
    public static final int OP_IP_SUB       = 0x76;
    public static final int OP_IP_MUL       = 0x77;
    public static final int OP_IP_DIV       = 0x78;
    public static final int OP_IP_MOD       = 0x79;
    public static final int OP_IP_SHL       = 0x7A;
    public static final int OP_IP_SHR       = 0x7B;
    public static final int OP_IP_USHR      = 0x7C;
    public static final int OP_IP_AND       = 0x7D;
    public static final int OP_IP_OR        = 0x7E;
    public static final int OP_IP_XOR       = 0x7F;

    public static final int OP_PIP_INC      = 0x80;
    public static final int OP_PIP_DEC      = 0x81;
    public static final int OP_PIP_INCA     = 0x82;
    public static final int OP_PIP_DECA     = 0x83;
    public static final int OP_PIP_INCB     = 0x84;
    public static final int OP_PIP_DECB     = 0x85;
    public static final int OP_PIP_ADD      = 0x86;
    public static final int OP_PIP_SUB      = 0x87;
    public static final int OP_PIP_MUL      = 0x88;
    public static final int OP_PIP_DIV      = 0x89;
    public static final int OP_PIP_MOD      = 0x8A;
    public static final int OP_PIP_SHL      = 0x8B;
    public static final int OP_PIP_SHR      = 0x8C;
    public static final int OP_PIP_USHR     = 0x8D;
    public static final int OP_PIP_AND      = 0x8E;
    public static final int OP_PIP_OR       = 0x8F;
    public static final int OP_PIP_XOR      = 0x90;
    public static final int OP_RSVD_8F      = 0x91;

    public static final int OP_I_GET        = 0x92;
    public static final int OP_I_SET        = 0x93;
    public static final int OP_RSVD_92      = 0x94;
    public static final int OP_IIP_INC      = 0x95;
    public static final int OP_IIP_DEC      = 0x96;
    public static final int OP_IIP_INCA     = 0x97;
    public static final int OP_IIP_DECA     = 0x98;
    public static final int OP_IIP_INCB     = 0x99;
    public static final int OP_IIP_DECB     = 0x9A;
    public static final int OP_IIP_ADD      = 0x9B;
    public static final int OP_IIP_SUB      = 0x9C;
    public static final int OP_IIP_MUL      = 0x9D;
    public static final int OP_IIP_DIV      = 0x9E;
    public static final int OP_IIP_MOD      = 0x9F;
    public static final int OP_IIP_SHL      = 0xA0;
    public static final int OP_IIP_SHR      = 0xA1;
    public static final int OP_IIP_USHR     = 0xA2;
    public static final int OP_IIP_AND      = 0xA3;
    public static final int OP_IIP_OR       = 0xA4;
    public static final int OP_IIP_XOR      = 0xA5;

    public static final int OP_M_GET        = 0xA6;
    public static final int OP_M_SET        = 0xA7;
    public static final int OP_M_VAR        = 0xA8;
    public static final int OP_M_REF        = 0xA9;
    public static final int OP_MIP_INC      = 0xAA;
    public static final int OP_MIP_DEC      = 0xAB;
    public static final int OP_MIP_INCA     = 0xAC;
    public static final int OP_MIP_DECA     = 0xAD;
    public static final int OP_MIP_INCB     = 0xAE;
    public static final int OP_MIP_DECB     = 0xAF;
    public static final int OP_MIP_ADD      = 0xB0;
    public static final int OP_MIP_SUB      = 0xB1;
    public static final int OP_MIP_MUL      = 0xB2;
    public static final int OP_MIP_DIV      = 0xB3;
    public static final int OP_MIP_MOD      = 0xB4;
    public static final int OP_MIP_SHL      = 0xB5;
    public static final int OP_MIP_SHR      = 0xB6;
    public static final int OP_MIP_USHR     = 0xB7;
    public static final int OP_MIP_AND      = 0xB8;
    public static final int OP_MIP_OR       = 0xB9;
    public static final int OP_MIP_XOR      = 0xBA;

    public static final int OP_CALL_00      = 0xBB;
    public static final int OP_CALL_01      = 0xBC;
    public static final int OP_CALL_0N      = 0xBD;
    public static final int OP_CALL_0T      = 0xBE;
    public static final int OP_CALL_10      = 0xBF;
    public static final int OP_CALL_11      = 0xC0;
    public static final int OP_CALL_1N      = 0xC1;
    public static final int OP_CALL_1T      = 0xC2;
    public static final int OP_CALL_N0      = 0xC3;
    public static final int OP_CALL_N1      = 0xC4;
    public static final int OP_CALL_NN      = 0xC5;
    public static final int OP_CALL_NT      = 0xC6;
    public static final int OP_CALL_T0      = 0xC7;
    public static final int OP_CALL_T1      = 0xC8;
    public static final int OP_CALL_TN      = 0xC9;
    public static final int OP_CALL_TT      = 0xCA;

    public static final int OP_NVOK_00      = 0xCB;
    public static final int OP_NVOK_01      = 0xCC;
    public static final int OP_NVOK_0N      = 0xCD;
    public static final int OP_NVOK_0T      = 0xCE;
    public static final int OP_NVOK_10      = 0xCF;
    public static final int OP_NVOK_11      = 0xD0;
    public static final int OP_NVOK_1N      = 0xD1;
    public static final int OP_NVOK_1T      = 0xD2;
    public static final int OP_NVOK_N0      = 0xD3;
    public static final int OP_NVOK_N1      = 0xD4;
    public static final int OP_NVOK_NN      = 0xD5;
    public static final int OP_NVOK_NT      = 0xD6;
    public static final int OP_NVOK_T0      = 0xD7;
    public static final int OP_NVOK_T1      = 0xD8;
    public static final int OP_NVOK_TN      = 0xD9;
    public static final int OP_NVOK_TT      = 0xDA;

    public static final int OP_NEW_0        = 0xDB;
    public static final int OP_NEW_1        = 0xDC;
    public static final int OP_NEW_N        = 0xDD;
    public static final int OP_NEW_T        = 0xDE;
    public static final int OP_NEWG_0       = 0xDF;
    public static final int OP_NEWG_1       = 0xE0;
    public static final int OP_NEWG_N       = 0xE1;
    public static final int OP_NEWG_T       = 0xE2;
    public static final int OP_NEWC_0       = 0xE3;
    public static final int OP_NEWC_1       = 0xE4;
    public static final int OP_NEWC_N       = 0xE5;
    public static final int OP_NEWC_T       = 0xE6;
    public static final int OP_NEWCG_0      = 0xE7;
    public static final int OP_NEWCG_1      = 0xE8;
    public static final int OP_NEWCG_N      = 0xE9;
    public static final int OP_NEWCG_T      = 0xEA;

    public static final int OP_CONSTR_0     = 0xEB;
    public static final int OP_CONSTR_1     = 0xEC;
    public static final int OP_CONSTR_N     = 0xED;
    public static final int OP_CONSTR_T     = 0xEF;
    public static final int OP_SYN_INIT     = 0xF0;
