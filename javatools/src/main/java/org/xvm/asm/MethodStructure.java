...
public class MethodStructure
    ...
    /**
     * @return the number of steps to get to the "outer this" class from this method
     */
    ...
    public void collectInjections(Set<InjectionKey> setInjections)
        ...
        // first, using the local constant pool, quickly check if there are any injections
        ConstantPool pool   = getConstantPool();
