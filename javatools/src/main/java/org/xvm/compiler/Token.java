...
import static org.xvm.util.Handy.truncate;
...
public class Token {
    ...
    public enum Id {
        ...
        NONE         ("<none>"         );               // sentinel for null object pattern
        /**
         * Constructor.
         *
    ...
    /**
     * A sentinel token representing "no token" to avoid null checks.
     */
    public static final Token NONE = new Token(0, 0, Id.NONE);
