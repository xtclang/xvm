...
// TODO CP case NOT: (non-auto-narrow type)
    ...
    protected Mark mark() {
        ...
        mark.token     = m_token        == null ? null : new Token(m_token);
        mark.putBack   = m_tokenPutBack == null ? null : new Token(m_tokenPutBack);
        mark.lastMatch = m_tokenPrev    == null ? null : new Token(m_tokenPrev);
        mark.doc       = m_doc;
