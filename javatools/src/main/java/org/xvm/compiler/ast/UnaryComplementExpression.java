...
public final class UnaryComplementExpression
    ...
    protected Expression validate(Context ctx, TypeConstant typeRequired, ErrorListener errs) {
        ...
        if (operator.getId() == Id.NOT) {
            ...
            fBoolean  = true;
        } else if (typeRequired != null && exprRight.testFit(ctx, typeRequired, false, ErrorListener.PROBE).isFit()
     ...
     */
    protected UnaryComplementExpression(UnaryComplementExpression that) {
        super(that);
    }
