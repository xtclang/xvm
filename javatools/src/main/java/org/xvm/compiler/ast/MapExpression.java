...
public final class MapExpression
    ...
    public TypeConstant getImplicitType(Context ctx) {
        TypeConstant typeExplicit = type.ensureTypeConstant(ctx, ErrorListener.PROBE);
     ...
     */
    protected MapExpression(MapExpression that) {
        super(that);
        this.type = that.type;
        this.keys = that.keys;
        this.values = that.values;
        this.lEndPos = that.lEndPos;
        this.m_aKeyAST = that.m_aKeyAST;
        this.m_aValueAST = that.m_aValueAST;
    }
