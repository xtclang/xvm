...
public final class VariableDeclarationStatement
     ...
     */
    protected VariableDeclarationStatement(VariableDeclarationStatement that) {
        super(that);
        this.type = that.type;
        this.name = that.name;
        this.term = that.term;
        this.m_reg = that.m_reg;
        this.m_exprName = that.m_exprName;
        this.m_fConstAnno = that.m_fConstAnno;
    }
