...
class SimpleCanaryGcTest {
    ...
    static final long OBJ_SIZE = REF_SIZE + ShallowSizeOf.instanceOf(C.class);
    static final long LIST_SIZE = REF_SIZE + ShallowSizeOf.instanceOf(CollectibleList.class) + ShallowSizeOf.instanceOf(ArrayList.class) + ShallowSizeOf.arrayOf(C.class, 16);
