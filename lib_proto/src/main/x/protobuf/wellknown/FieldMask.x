 ...
 * FieldMask defined in the proto file google/protobuf/field_mask.proto
 */
@protobuf.WellKnownLocation("google.protobuf.FieldMask")
class FieldMask
    ...
    @Override
    construct(FieldMask other) {
        construct protobuf.AbstractMessage(other);
        paths = other.paths.duplicate();
    }
    ...
    Boolean parseField(protobuf.CodedInput input, Int tag) {
        ...
        case 1:
            if (paths.is(immutable)) {
                paths = new ecstasy.collections.Array(Mutable, paths);
            }
            paths.add(input.readString());
            return True;
        }
        return False;
    }
    ...
    @Override
    FieldMask! mergeFrom(FieldMask other) {
        if (this.is(immutable)) {
            return new FieldMask(this).mergeFrom(other);
        }
    ...
    @Override
    immutable FieldMask freeze(Boolean inPlace = False) {
        if (this.is(immutable FieldMask)) {
            return this;
        }
        if (!inPlace) {
            return new FieldMask(this).freeze(True);
        }
