...
public class DirectStrategy implements ExecutionStrategy {
    ...
    private final Provider<DirectRuntimeBuildService> directRuntimeService;

    public DirectStrategy(final Logger logger, final Provider<DirectRuntimeBuildService> directRuntimeService) {
        this.logger = logger;
        this.directRuntimeService = directRuntimeService;
    }
