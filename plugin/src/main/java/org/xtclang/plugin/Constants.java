...
public final class Constants {
    ...
    public static final String XTC_VERSION_GROUP_NAME = "version";
    public static final String XTC_VERSION_FILE_TASK_NAME = "versionFile";
    public static final String XTC_VERSION_TASK_NAME = XTC_VERSION_GROUP_NAME;
    ...
    public static final String JAVATOOLS_ARTIFACT_ID = "javatools";
    public static final String XTC_CONFIG_NAME_JAVATOOLS_INCOMING = "xtcJavaTools";
    public static final String XTC_CONFIG_NAME_JAVATOOLS_OUTGOING = XTC_CONFIG_NAME_JAVATOOLS_INCOMING + "Provider";
    ...
    public static final String XTC_COMPILER_LAUNCHER_NAME = "xtc";
