...
class TextMateGenerator(private val model: LanguageModel) {
    ...
    fun generate(): String {
        val grammar = buildJsonObject {
            ...
            putJsonObject("repository") {
                ...
                putJsonObject("expression") {
                    putJsonArray("patterns") {
                        ...
                        addJsonObject { put("include", "#function-call") }
                    }
                }
            }
            ...
            // Main patterns
            putJsonArray("patterns") {
                addJsonObject { put("include", "#comments") }
                addJsonObject { put("include", "#annotations") }
                addJsonObject { put("include", "#module-declaration") }
                addJsonObject { put("include", "#class-declaration") }
                addJsonObject { put("include", "#method-declaration") }
                addJsonObject { put("include", "#keywords") }
