...
val xtcLanguage =
    language(
        ...
        // NOTE: Async invocation ^(args) is handled by async_call_expression in the grammar,
        // not as a binary operator. The ^( token is defined inline in the grammar.
