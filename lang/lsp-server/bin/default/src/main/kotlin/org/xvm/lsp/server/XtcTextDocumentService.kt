...
class XtcTextDocumentService(
    ...
    private fun toCompletionItemKind(kind: CompletionItem.CompletionKind): CompletionItemKind =
        when (kind) {
            CompletionItem.CompletionKind.CLASS -> CompletionItemKind.Class
            CompletionItem.CompletionKind.INTERFACE -> CompletionItemKind.Interface
            CompletionItem.CompletionKind.METHOD -> CompletionItemKind.Method
            CompletionItem.CompletionKind.PROPERTY -> CompletionItemKind.Property
            CompletionItem.CompletionKind.VARIABLE -> CompletionItemKind.Variable
            CompletionItem.CompletionKind.KEYWORD -> CompletionItemKind.Keyword
            CompletionItem.CompletionKind.MODULE -> CompletionItemKind.Module
        }
    ...
    private fun toLspSelectionRange(range: SelectionRange): org.eclipse.lsp4j.SelectionRange =
    ...
    private fun TypeHierarchyItem.toLsp(defaultUri: String): org.eclipse.lsp4j.TypeHierarchyItem {
    ...
    private fun org.eclipse.lsp4j.TypeHierarchyItem.toAdapter(): org.xvm.lsp.adapter.TypeHierarchyItem =
        org.xvm.lsp.adapter.TypeHierarchyItem(
            name = name,
    ...
    private fun CallHierarchyItem.toLspCallItem(): org.eclipse.lsp4j.CallHierarchyItem {
        val result =
    ...
    private fun org.eclipse.lsp4j.CallHierarchyItem.toAdapterCallItem(): org.xvm.lsp.adapter.CallHierarchyItem =
        org.xvm.lsp.adapter.CallHierarchyItem(
            name = name,
    ...
    private fun Position.toAdapterPosition() =
        org.xvm.lsp.adapter
