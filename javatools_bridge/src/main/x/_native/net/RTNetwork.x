...
service RTNetwork(Boolean secure)
    ...
    @Override
    @RO NetworkInterface[] interfaces.get() {TODO("Native");}

    @Override
    conditional Algorithms isSecure() {TODO("Native");}

    @Override
    conditional NetworkInterface defaultInterface() {TODO("Native");}

    @Override
    conditional NetworkInterface interfaceByName(String name) {TODO("Native");}
    ...
    conditional NetworkInterface nativeNicByAddress(Byte[] addressBytes) {TODO("Native");}
