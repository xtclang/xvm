import ecstasy.io;
import ecstasy.collections.ConstantRequired;
...
//        incorporates conditional NumberArray<Element extends Number>
...
//        incorporates conditional ConstArray<Element extends immutable Const>
    {
    // ----- constructors --------------------------------------------------------------------------
     ...
     */
    construct(Array array, Interval<Int> section)  // TODO CP add support for inclusive/exclusive
        {
     ...
     */
    private construct(ArrayDelegate<Element> delegate)
        {
    ...
    Int capacity
        ...
        Int get()
            {
            if (ArrayDelegate<Element> delegate ?= this.delegate)
                {
    ...
    Array fill(Element value, Interval<Int>? interval = Null)
        ...
        if (interval == Null)
            ...
            {
            assert interval.effectiveLowerBound >= 0 && interval.adjoins([0..size));
            }
...
//        }
    ...
    private static interface ArrayDelegate<Element>
         ...
         *
         */
        ArrayDelegate replace(Int index, Element value)
...
// TODO CP something like verifyMax2sComplementBytes() etc.
    ...
    // ----- IntNumberArray mixin ------------------------------------------------------------------

    static mixin NumberArray<Element extends IntNumber>
        {
        }

    static mixin IntNumberArray<Element extends IntNumber>
        {
        /**
         * Bitwise AND, `n:1`.
         *
         * @param value  the value to bitwise-AND with each value in this array
         *
         * @return the resulting array
         */
        IntNumberArray and(Element value)
            {
            }
         ...
         * Bitwise AND, `n:n`.
         *
         * @param that  an array of identical size whose values will be used to bitwise-AND with
         *              each value in this array
         *
         * @return the resulting array, which is this array if the
         */
        IntNumberArray and(IntNumberArray that)
            {
            }
         ...
         */
        @Op("|")
        IntNumberArray or(IntNumberArray that);

        /**
         * Bitwise XOR.
         */
        @Op("^")
        IntNumberArray xor(IntNumberArray that);
         ...
         */
        @Op("<<")
        IntNumberArray shiftLeft(Int count);
         ...
         */
        @Op(">>")
        IntNumberArray shiftRight(Int count);
         ...
         */
        @Op(">>>")
        IntNumberArray shiftAllRight(Int count);

        /**
         * Rotate bits left.
         */
        IntNumberArray rotateLeft(Int count);

        /**
         * Rotate bits right.
         */
        IntNumberArray rotateRight(Int count);
