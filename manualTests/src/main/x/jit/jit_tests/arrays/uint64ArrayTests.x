...
package uint64ArrayTests {
    ...
    void shouldCreateConstantArray() {
        ...
        assert array.size == 3;
        assert array[0] == 10 && array[1] == 20 && array[2] == UInt64.MaxValue;
    }
    ...
    void shouldPreInc() {
        ...
        array.add(10);
        array.add(20);
        array.add(UInt64.MaxValue);
        UInt64 c = ++array[1];
        assert c == 21;
        assert array[0] == 10 && array[1] == 21 && array[2] == UInt64.MaxValue;
    }
    ...
    void shouldPreDec() {
        ...
        assert array[0] == 10 && array[1] == 20 && array[2] == (UInt64.MaxValue - 1);
    }
    ...
    void shouldAddInPlace() {
        ...
        array.add(UInt64.MaxValue);
        array[1] += 5;
        assert array[0] == 10 && array[1] == 25 && array[2] == UInt64.MaxValue;
    }
    ...
    void shouldSubInPlace() {
        ...
        array.add(UInt64.MaxValue);
        array[2] -= 5;
        assert array[0] == 10 && array[1] == 20 && array[2] == (UInt64.MaxValue - 5);
    }
