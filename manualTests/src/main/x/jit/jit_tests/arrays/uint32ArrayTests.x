...
package uint32ArrayTests {
    ...
    void shouldCreateWithCapacity() {
        UInt32[] array = new Array(10);
        assert array.capacity >= 10;
    }

    void shouldCreateArrayInitializedWithZeroValue() {
        UInt32[] array = new UInt32[4](0);
    ...
    void shouldCreateConstantArray() {
        ...
        assert array.size == 3;
        assert array[0] == 10 && array[1] == 20 && array[2] == UInt32.MaxValue;
    }
    ...
    void shouldPreInc() {
        ...
        UInt32 c = ++array[1];
        assert c == 21;
        assert array[0] == 10 && array[1] == 21 && array[2] == UInt32.MaxValue;
    }
    ...
    void shouldPreDec() {
        ...
        assert array[0] == 10 && array[1] == 20 && array[2] == (UInt32.MaxValue - 1);
    }
    ...
    void shouldAddInPlace() {
        ...
        array.add(UInt32.MaxValue);
        array[1] += 5;
        assert array[0] == 10 && array[1] == 25 && array[2] == UInt32.MaxValue;
    }
    ...
    void shouldSubInPlace() {
        ...
        array.add(UInt32.MaxValue);
        array[2] -= 5;
        assert array[0] == 10 && array[1] == 20 && array[2] == (UInt32.MaxValue - 5);
    }
