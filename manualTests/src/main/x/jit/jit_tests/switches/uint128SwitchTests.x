/**
 * Various types of switch statement using UInt128 values.
 */
package uint128SwitchTests {
    @Inject Console console;

    void run() {
        console.print(">>>> Running UInt128 switch tests >>>>");
        ...
        console.print(">>>> Finished UInt128 switch tests >>>>");
    }

    void testSimpleSwitch() {
        assert performSimpleSwitch(1) == "one";
        assert performSimpleSwitch(18446744073709551620) == "two";
        assert performSimpleSwitch(3) == "default";
    }

    String performSimpleSwitch(UInt128 n) {
        switch (n) {
        case 1:
            return "one";
        case 18446744073709551620:
            return "two";
        default:
            return "default";
        }
    ...
    String performSimpleSwitchWithNullable(UInt128? n) {
        switch (n) {
        case 1:
            return "one";
        case 2:
    ...
    String performSimpleSwitchWithNullableAndNullCase(UInt128? n) {
        switch (n) {
        case Null:
            return "**Null**";
        case 1:
    ...
    void testSimpleSwitchMultiCases() {
        ...
        assert performSimpleSwitchMultiCases(18446744073709551620) == "two";
        assert performSimpleSwitchMultiCases(7) == "default";
    }

    String performSimpleSwitchMultiCases(UInt128 n) {
        switch (n) {
        case 1, 3, 5:
            return "one";
        case 2, 4, 18446744073709551620:
            return "two";
        default:
            return "default";
        }
    ...
    void testSimpleSwitchMixedCases() {
        ...
        assert performSimpleSwitchMixedCases(18446744073709551620) == "one";
    ...
    String performSimpleSwitchMixedCases(UInt128 n) {
        switch (n) {
        case 1, 3, 11..15, 18446744073709551620:
            return "one";
        case 2, 5..10, 18:
            return "two";
        default:
    ...
    String performSimpleSwitchNoDefault(UInt128 n) {
        switch (n) {
        case 1:
            return "one";
        case 2:
    ...
    String performSimpleSwitchWithBreak(UInt128 n) {
        String s = "";
        switch (n) {
        case 1:
            s = "one";
    ...
    Int performSimpleSwitchWithContinue(UInt128 i) {
        Int n = 0;
        switch (i) {
        case 1:
            n += 1;
    ...
    void testMultiSwitch() {
        ...
        assert performMultiSwitch(3, 18446744073709551620) == "two";
        assert performMultiSwitch(1, 3) == "default";
        assert performMultiSwitch(4, 2) == "default";
    }

    String performMultiSwitch(UInt128 n1, UInt128 n2) {
        switch (n1, n2) {
        case (1, 2):
            return "one";
        case (3, 18446744073709551620):
            return "two";
        default:
            return "default";
        }
    ...
    String performMultiSwitchWithNoDefault(UInt128 n1, UInt128 n2) {
        switch (n1, n2) {
        case (1, 2):
            return "one";
        case (3, 4):
    ...
    String performMultiSwitchWithBreak(UInt128 n1, UInt128 n2) {
        String s = "";
        switch (n1, n2) {
        case (1, 2):
            s = "one";
    ...
    Int performMultiSwitchWithContinue(UInt128 n1, UInt128 n2) {
        Int n = 0;
        switch (n1, n2) {
        case (1, 2):
            n = n + 1;
    ...
    String performMultiSwitchMultiCases(UInt128 n1, UInt128 n2) {
        switch (n1, n2) {
        case (1, 2), (3, 2), (5, 2),
             (1, 4), (3, 4), (5, 4),
             (1, 6), (3, 6), (5, 6):
    ...
    String performMultiSwitchMultiCasesWithRanges(UInt128 n1, UInt128 n2) {
        switch (n1, n2) {
        case (1, 2), (3, 2), (5, 2),
             (1, 4..8), (3, 4..8), (5, 4..8),
             (1, 10), (3, 10), (5, 10):
    ...
    void testRangeSwitch() {
        ...
        assert performRangeSwitch(18446744073709551620) == "two";
        assert performRangeSwitch(18446744073709551626) == "two";
        assert performRangeSwitch(11) == "default";
    }

    String performRangeSwitch(UInt128 n) {
        switch (n) {
        case 1..5:
            return "one";
        case 18446744073709551620..18446744073709551626:
            return "two";
        default:
            return "default";
        }
