...
package int32SwitchTests {
    ...
    String performSimpleSwitch(Int32 n) {
        switch (n) {
        case 1:
            return "one";
        case 2:
    ...
    String performSimpleSwitchWithNullable(Int32? n) {
        switch (n) {
        case 1:
            return "one";
        case 2:
    ...
    String performSimpleSwitchWithNullableAndNullCase(Int32? n) {
        switch (n) {
        case Null:
            return "**Null**";
        case 1:
    ...
    String performSimpleSwitchMultiCases(Int32 n) {
        switch (n) {
        case 1, 3, 5:
            return "one";
        case 2, 4, 6:
    ...
    String performSimpleSwitchMixedCases(Int32 n) {
        switch (n) {
        case 1, 3, 11..15, 20:
            return "one";
        case 2, 5..10, 18:
    ...
    String performSimpleSwitchNoDefault(Int32 n) {
        switch (n) {
        case 1:
            return "one";
        case 2:
    ...
    String performSimpleSwitchWithBreak(Int32 n) {
        String s = "";
        switch (n) {
        case 1:
            s = "one";
    ...
    Int performSimpleSwitchWithContinue(Int32 i) {
        Int n = 0;
        switch (i) {
        case 1:
            n += 1;
    ...
    String performMultiSwitch(Int32 n1, Int32 n2) {
        switch (n1, n2) {
        case (1, 2):
            return "one";
        case (3, 4):
    ...
    String performMultiSwitchWithNoDefault(Int32 n1, Int32 n2) {
        switch (n1, n2) {
        case (1, 2):
            return "one";
        case (3, 4):
    ...
    String performMultiSwitchWithBreak(Int32 n1, Int32 n2) {
        String s = "";
        switch (n1, n2) {
        case (1, 2):
            s = "one";
    ...
    Int performMultiSwitchWithContinue(Int32 n1, Int32 n2) {
        Int n = 0;
        switch (n1, n2) {
        case (1, 2):
            n = n + 1;
    ...
    String performMultiSwitchMultiCases(Int32 n1, Int32 n2) {
        switch (n1, n2) {
        case (1, 2), (3, 2), (5, 2),
             (1, 4), (3, 4), (5, 4),
             (1, 6), (3, 6), (5, 6):
    ...
    String performMultiSwitchMultiCasesWithRanges(Int32 n1, Int32 n2) {
        switch (n1, n2) {
        case (1, 2), (3, 2), (5, 2),
             (1, 4..8), (3, 4..8), (5, 4..8),
             (1, 10), (3, 10), (5, 10):
    ...
    String performRangeSwitch(Int32 n) {
        switch (n) {
        case 1..5:
            return "one";
        case 6..10:
