...
package uint128ArrayTests {
    ...
    void shouldCreateConstantArray() {
        ...
        assert array.size == 3;
        assert array[0] == 10 && array[1] == 20 && array[2] == UInt128.MaxValue;
    }
    ...
    void shouldPreInc() {
        ...
        array.add(10);
        array.add(20);
        array.add(UInt128.MaxValue);
        UInt128 c = ++array[1];
        assert c == 21;
        assert array[0] == 10 && array[1] == 21 && array[2] == UInt128.MaxValue;
    }
    ...
    void shouldPreDec() {
        ...
        assert array[0] == 10 && array[1] == 20 && array[2] == (UInt128.MaxValue - 1);
    }
    ...
    void shouldAddInPlace() {
        ...
        array.add(UInt128.MaxValue);
        array[1] += 5;
        assert array[0] == 10 && array[1] == 25 && array[2] == UInt128.MaxValue;
    }
    ...
    void shouldSubInPlace() {
        ...
        array.add(UInt128.MaxValue);
        array[2] -= 5;
        assert array[0] == 10 && array[1] == 20 && array[2] == (UInt128.MaxValue - 5);
    }
    ...
    void shouldInsertValueIntoArray() {
        ...
        // insert in middle
        array.insert(2, 18446744073709551616);
        assert array.size == 5;
        assert array[0] == 10 && array[1] == 20 && array[2] == 18446744073709551616 && array[3] == 40;
        assert array[4] == 50;

        // insert at index zero
        array.insert(0, 5);
        assert array.size == 6;
        assert array[0] == 5  && array[1] == 10 && array[2] == 20 && array[3] == 18446744073709551616;
        assert array[4] == 40 && array[5] == 50;

        // insert at the end
        array.insert(array.size, 60);
        assert array.size == 7;
        assert array[0] == 5  && array[1] == 10 && array[2] == 20 && array[3] == 18446744073709551616;
        assert array[4] == 40 && array[5] == 50 && array[6] == 60;
    }
}
