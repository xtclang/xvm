/**
 * A stand-alone test for PeopleDB v1.
 *
 * To run, from "./manualTests/" directory:
 *      xcc -o lib/v1 src/main/x/dbTests/v1/PeopleDB.x
 *      xec -L lib/v1 -o lib/v1 src/main/x/dbTests/v1/PeopleTest.x
 */
module PeopleTest
        incorporates TerminalApp.Mixin("People DB Test V1") {
    ...
    void addPerson(String first, String? last = Null) {
        Person person = new Person(Null, first, last);
