module TestSimple {
    ...
    void run() {
        ...
        console.print("\n*** test3");
        console.print(new test3.Base<String>().add("hello1"));
    }
    ...
    package test3 {
        mixin MixIn<Element extends Const>
                into Base<Element> {

            // this used to compile without the @Override though it should have not
        ...
        class Base<Element>
                ...
                incorporates conditional MixIn<Element extends Const> {
