...
const UInt8
     ...
     *
     * @return  an Nibble that has the same bit pattern as the low order 4 bits of this UInt16
     *
     * @throws OutOfBounds if checkBounds is True and this UInt8 is higher then Nibble.MaxValue
     */
    @Override
