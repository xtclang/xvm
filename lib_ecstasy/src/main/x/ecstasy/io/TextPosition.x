...
interface TextPosition
    ...
    /**
     * Obtain a snapshot of the `TextPosition`'s information.
     *
     * @return an immutable snapshot of this `TextPosition` (which may be this `TextPosition` if it
     *         is an immutable snapshot)
     */
    immutable TextPosition reify() = snapshot(this);
